...
frames_edit[[535]]
save(frames, frames_edit, file = "moveVis_frames.RData")
```
...
![Animación de los movimientos del jaguar Courisco en la Caatinga brasilera realizada en _movevis_](docs/Figures/courisco.gif){#fig-courisco fig-alt="movimientos del jaguar Courisco en _movevis_"}

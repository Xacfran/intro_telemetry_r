...
Actualmente, puedes utilizar R mediante cuatro IDEs.
El recomendado y más ampliamente utilizado es R Studio, el cual también puedes utilizarlo en la web a través de [Posit Cloud](https://posit.cloud/).
...
Una vez hayas creado tu cuenta, verás una ventana como la siguiente y allí podrás crear un nuevo proyecto.

![](docs/Figures/posit_cloud_start.png)

Si eres un usuario avanzado te recomiendo utilizarlo a través de [Positron](https://positron.posit.co/start.html) o [Visual Studio Code](https://code.visualstudio.com/). Positron aún está en versión Beta, pero tiene gran potencial, y ha sido diseñado a partir de Visual Studio Code pero con mayores ajustes al análisis de datos con R.

En este curso, vamos a utilizar R y R Studio localmente en nuestro computador, para lo cual debes contar con acceso a internet y cualquier navegador web de tu preferencia, Chrome, Firefox, etc.

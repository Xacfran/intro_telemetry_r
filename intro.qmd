...
author: "Francisco X. Castellanos<br>
...
# Estructura de datos: Objetos, vectores, *data frames*, y listas.
...
Una vez descargado, este ya se encuentra almacenado en tu computadora, en la dirección que indica la consola.
Ahora, para poder usarlo solamente debes activarlo mediante:
...
El presente trabajo ha sido escrito y editado por [Francisco Castellanos](https://orcid.org/0000-0003-0955-8185) y está influenciado por la clase "Introducción Básica al Lenguaje de R" de [Juan Pablo Zurano](https://www.researchgate.net/profile/Juan-Zurano-3), así como también: [YaRrr](https://bookdown.org/ndphillips/YaRrr/writing-r-scripts-in-an-editor.html) y [The R Book](https://www.cs.upc.edu/~robert/teaching/estadistica/TheRBook.pdf).
<br> <br>

...
Existen algunas opciones para exportar los gráficos generados en R, una de ellas es `ggsave`. Por default ggsave exporta la última figura generada, pero también puedes guardar cualquier imagen como un objeto y exportarla en cualquier punto de tu trabajo. Exportar utilizando esta función te da mucho control sobre la calidad y extensión de la figura. [Esta guía](https://ggplot2.tidyverse.org/reference/ggsave.html) te da muchos más detalles sobre los argumentos que puedes utilizar dentro de la función. Para mantener las cosas sencillas en este curso, utiliza el siguiente código para exportar la última imagen generada
